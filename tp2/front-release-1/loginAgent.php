...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT id, email, zone_number ,password FROM agent WHERE email = ?";
        ...
        if($stmt = $mysqli->prepare($sql)){
            ...
            if($stmt->execute()){
                ...
                if($stmt->num_rows == 1){                    
                    ...
                    $stmt->bind_result($id, $email,$zone,$password);
                    if($stmt->fetch()){
    ...
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span>ELECTRICAL WEB
      ...
      <div id="navcol-1" class="collapse navbar-collapse" style="padding-left: 0px;">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item"><a class="nav-link active" href="/loginAgent.php">Agent</a></li>
