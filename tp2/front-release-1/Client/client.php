    ...
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span>ELECTRICAL WEB SITE</span></a><button class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div id="navcol-1" class="collapse navbar-collapse" style="padding-left: 0px;">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"></li>
                <li class="nav-item"><a class="nav-link" href="client.php">Mes factures</a></li>
                <li class="nav-item"></li>
...
</nav><section class="py-5 mt-5"><!-- Start: Testimonials --><div class="container py-5">
    <div class="row mb-5">
            ...
            <table class="table table-hover table-bordered">
                <thead class="bill-header cs">
                    <tr>
                        ...
                        <th id="trs-hd-2" class="col-lg-2">Mois</th>
                        <th id="trs-hd-3" class="col-lg-2">Consomation</th>
                        <th id="trs-hd-4" class="col-lg-3">prix HT en MAD</th>
                        <th id="trs-hd-5" class="col-lg-2">Prix TTC en MAD</th>
                        <th id="trs-hd-6" class="col-lg-2">Status</th>
                        <th id="trs-hd-7" class="col-lg-5">Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>15000</td>
                        <td>payee</td>
                        <td><button class="btn btn-success" style="margin-left: 5px;" type="submit">Telecharger facture</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
    </div>
</div><!-- End: Testimonials --><!-- Start: Testimonials --><div class="container py-5"><div class="row mb-5"><div class="col-md-8 col-xl-6 text-center mx-auto"><h2 class="fw-bold"><br><span class="underline pb-2">Options</span></h2></div></div><div class="table-responsive"><table class="table"><thead><tr><th>Options</th><th>Actions</th></tr></thead><tbody><tr><td>Ajouter consomation</td><td><button class="btn btn-primary" type="button">Ajouter&nbsp; consomation</button></td></tr><tr><td>Ajouter reclamation</td><td><button class="btn btn-primary" type="button">Ajouter reclamation</button></td></tr></tbody></table></div></div><!-- End: Testimonials --></section><div class="btn-toolbar"><div class="btn-group" role="group"></div><div class="btn-group" role="group"></div></div><!-- Start: Footer Multi Column --><footer><div class="container py-4 py-lg-5"><hr><div class="text-muted d-flex justify-content-between align-items-center pt-3"><p class="mb-0">Copyright © 2023&nbsp;</p><ul class="list-inline mb-0"><li class="list-inline-item"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
