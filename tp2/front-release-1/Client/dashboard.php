        ...
        <div class="table-responsive table table-hover table-bordered results">
            <table class="table table-hover table-bordered">
                <thead class="bill-header cs">
                    <tr>
                        <th id="trs-hd-1" class="col-lg-1">Id facture</th>
                        ...
                        <th id="trs-hd-6" class="col-lg-2">Zone Geographique ID</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>15000</td>
                        <td>01</td>
                        <td><button class="btn btn-success" style="margin-left: 5px;" type="submit">Payez votre facture</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
    </div>
</div><!-- End: Testimonials --></section><div class="btn-toolbar"><div class="btn-group" role="group"></div><div class="btn-group" role="group"></div></div><!-- Start: Footer Multi Column --><footer><div class="container py-4 py-lg-5"><hr><div class="text-muted d-flex justify-content-between align-items-center pt-3"><p class="mb-0">Copyright © 2023&nbsp;</p><ul class="list-inline mb-0"><li class="list-inline-item"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-facebook">
